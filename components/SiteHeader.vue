<template>
  <header class="header" role="banner">
    ...
    <button type="button" class="hamburger" @click="showMenu">
      <svg style="isolation:isolate" viewBox="1369.79 44 28.08 21.6" width="28.08" height="21.6">
        <g><path d="M1369.79 44h28.08v4.32h-28.08zM1369.79 61.28h28.08v4.32h-28.08zM1369.79 52.64h28.08v4.32h-28.08z"/></g>
      </svg>
    </button>
    <div class="menu-overlay" v-show="isShowMenu">
      <div class="menu-angle"></div>
      <div class="menu-block">
        <button type="button" class="menu-close" @click="hideMenu"><svg viewBox="1361 52 31 31" width="31" height="31"><path d="M1377.84 67.5l9.962 9.972-1.33 1.33-9.97-9.96-9.974 9.96-1.33-1.33 9.96-9.972-9.96-9.972 1.33-1.33 9.972 9.96 9.972-9.96 1.33 1.33-9.96 9.97v.002z" fill="#132D5B"/><path fill="none" d="M1361 52h31v31h-31z"/></svg></button>
